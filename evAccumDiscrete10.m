...
%The code here produces an analog of Fig. 8.1 from the paper with larger
%thresholds and smaller SNR (i.e. p is close to q).
...
%respectively
p = exp(1)/10;  %Adjust these parameters to alter SNR.  Ensure p/q = e
q = 1/10;
s = 1-p-q;
...
%Threshold values
thetap = 50; %Adjust these to set threshold values.  Make sure the thresholds are symmetric.  This code breaks down otherwise.
thetam = -50;
